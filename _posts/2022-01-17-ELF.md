...
note that the normalization factor ($(N!)^{-1/2}$) is ignored here so that $|\Psi_{A S}|^2=N$ where $N$ is the number of electron in the system.
...
&= \{ |\psi_1(r_1)|^2 |\psi_2(r_2)|^2 + |\psi_1(r_2)|^2 |\psi_2(r_1)|^2\\ & \textcolor{red}{\quad + [ |\psi_1(r_1)|^2 |\psi_1(r_2)|^2 + |\psi_2(r_1)|^2 |\psi_2(r_2)|^2}\\
