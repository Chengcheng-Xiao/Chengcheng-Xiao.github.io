...
where $\chi_1 = \psi_1*\beta_1$. $\psi$ is the spacial orbital and $\beta$ (or for other spin channel $\alpha$) is the spin orbital ($\int \alpha(w) \beta(w) dw = 0$; $\int \beta(w) \beta(w) dw = 1$).
...
&= \frac{1}{2} \{ [ |\psi_1(r_1)|^2+|\psi_2(r_1)|^2] \cdot [|\psi_1(r_2)|^2+|\psi_2(r_2)|^2]\\ & \quad-|(\psi^*_1(r_1)\psi_1(r_2)+\psi^*_2(r_1)\psi_2(r_2))|^2 \}  dr_1 dr_2\\
