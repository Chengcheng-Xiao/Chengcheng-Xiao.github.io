...
$$
\Psi_{A S}= \frac{1}{\sqrt{2}} [\psi_1(r_1)\beta(\omega_1)\psi_2(r_2)\beta(\omega_2)-\psi_1(r_2)\beta(\omega_2)\psi_2(r_1)\beta(\omega_1)].
$$

The probability of finding the first electron at $r_1$ with $dr_1$ and the second electron at $r_2$ with $dr_2$ is:

$$
|\Psi|^2 dr_1 dr_2 d\omega_1 d\omega_2 = \frac{1}{2} |(\psi_1(r_1)\beta(\omega_1)\psi_2(r_2)\beta(\omega_2)-\psi_1(r_2)\beta(\omega_2)\psi_2(r_1)\beta(\omega_1))|^2 dr_1 dr_2 d\omega_1 d\omega_2
$$
