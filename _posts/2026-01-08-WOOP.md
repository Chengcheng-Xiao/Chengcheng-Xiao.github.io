...
Reference: https://pubs.rsc.org/en/content/articlepdf/2010/cp/b918890h<br>
Code repo: https://github.com/Chengcheng-Xiao/WOOPs
{% endcapture %}

{% include admonition.html type="quote" title="References" body=body_content %}
...
The choice of $m$ determines the properties of Wannier functions (i.e., which subset of bands they describe). One can construct molecular orbital-like Wannier functions by constraining $m$ to be only the occupied states. Or, atomic orbital-like Wannier functions by setting $m$ to also include the anti-bonding like states in the unoccupied manifold.

The main Goal of WOOP and WOPP is to decompose Wannier charge and dipole which are usually described by molecular-like Wannier orbitals (MOs) using a set of atomic-like Wannier orbitals (AOs).
